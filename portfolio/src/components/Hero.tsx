    ...
    <>
      <section className="pt-8 md:pt-20 pb-12">
        <div className="flex flex-col items-start max-w-2xl space-y-6 md:space-y-8">
          ...
          <div className="w-full sm:w-auto sm:inline-flex sm:flex-col">
            <div className="flex flex-row gap-2 sm:gap-4 pt-4 w-full sm:w-auto">
              <button
                onClick={scrollToExperience}
                className="group relative flex-1 sm:flex-initial sm:min-w-[140px] px-3 sm:px-6 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-accent/20 to-accent-strong/20 backdrop-blur-md text-white text-base font-semibold overflow-hidden transition-all duration-200 ease-out before:absolute before:inset-0 before:rounded-full before:p-[2px] before:bg-gradient-to-r before:from-accent before:to-accent-strong before:-z-10 before:transition-all before:duration-200 before:ease-out hover:shadow-glow-btn-strong hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center"
              >
                <span className="relative z-10 whitespace-nowrap">View Work</span>
              </button>
              <button
                onClick={() => setIsModalOpen(true)}
                className="btn-glass group flex-1 sm:flex-initial sm:min-w-[140px] px-3 sm:px-6 py-2.5 sm:py-3 text-base"
              >
                <span className="relative z-10 whitespace-nowrap">Contact</span>
              </button>
              <a
                href="/Joey Pilewski - Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                download="Joey_Pilewski_Resume.pdf"
                className="btn-glass group flex-1 sm:flex-initial sm:min-w-[140px] px-3 sm:px-6 py-2.5 sm:py-3 text-base gap-1.5 sm:gap-2"
              >

                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-4 flex gap-3">
                        <a
                            ...
                            className="flex-1 py-3 rounded-full border border-white/10 bg-white/5 text-white hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
                        >

                ...
                <div className="space-y-6">
                    ...
                    <div className="pt-4 flex gap-3">
                        <a
                            ...
                            className="flex-1 py-3 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-white/90 font-medium hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all duration-200 ease-out flex items-center justify-center gap-2"
                        >

                ...
                <section className="flex flex-wrap gap-4">
                    {project.links.demo && (
                        <a
                            ...
                            className="group relative px-6 py-3 rounded-full bg-white/5 backdrop-blur-sm border border-white/20 text-white/90 font-medium hover:bg-white/10 hover:border-accent/50 hover:shadow-[0_0_25px_rgba(139,92,246,0.3)] hover:scale-[1.02] transition-all duration-200 flex items-center gap-2"
                        >
                    ...
                    {project.links.testflight && (
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative px-6 py-3 rounded-full bg-white/5 backdrop-blur-sm border border-white/20 text-white/90 font-medium hover:bg-white/10 hover:border-accent/50 hover:shadow-[0_0_25px_rgba(139,92,246,0.3)] hover:scale-[1.02] transition-all duration-200 flex items-center gap-3"
                        >
                            <Image
